...
import WordleSelectBar from './WordleSelectBar';
...
function Home2() {
    ...
    // states for guessinfo and loaded info
        ...
        return (
            <div>
                ...
                <Row className = 'row g-0'>
                    <Col xs = {10} md = {7} lg = {5} xl  = {4} className = 'mx-auto d-flex justify-content-center'>
                        <WordleSelectBar selected = {selected} setSelected = {setSelected}/>
                    </Col>
                </Row>
                <Row className = 'row g-0'>
                    <Col xs = {11} md = {6} lg = {5} xl  = {4} className = 'mx-auto d-flex justify-content-center guess-display-wrapper'>
                        <Combine 
                        guessInfo = {allGuessInfo[selected]} 
                        wordleNum = {getWordleNumbers()[selected]} 
                        shrunk = {false}
                        uid = {auth.currentUser!.uid}
                        date = {getDates()[selected]} />
                    </Col>
                </Row>
                </div>
            </div>
